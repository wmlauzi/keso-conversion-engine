/**
 * How It Works — 3-step conversion flow.
 */
...
const HowItWorks = () => (
  <section className="py-20 md:py-28 bg-secondary text-secondary-foreground" aria-labelledby="how-heading">
    <div className="container">
      ...
      >
        ...
        <h2 id="how-heading" className="text-3xl md:text-4xl lg:text-5xl font-extrabold">How It Works</h2>
      </motion.header>

      <ol className="grid md:grid-cols-3 gap-10 max-w-4xl mx-auto list-none p-0">
        {steps.map((s, i) => (
          <motion.li
            key={s.title}
          ...
          >
            <div className="w-16 h-16 mx-auto rounded-full bg-primary/15 flex items-center justify-center mb-5" aria-hidden="true">
              <s.icon className="w-7 h-7 text-primary" />
            </div>
            <div className="text-3xl font-extrabold text-primary/40 mb-2" aria-hidden="true">0{i + 1}</div>
