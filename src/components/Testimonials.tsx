/**
 * Testimonials — social proof cards with star ratings.
 */
...
const Testimonials = () => (
  <section id="testimonials" className="py-20 md:py-28 bg-card" aria-labelledby="testimonials-heading">
    <div className="container">
      ...
      >
        ...
        <h2 id="testimonials-heading" className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-foreground">Testimonials</h2>
      </motion.header>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        {testimonials.map((t, i) => (
          ...
          >
            ...
            <footer className="font-bold text-foreground text-sm">— {t.name}</footer>
          </motion.blockquote>
        ))}
      </div>
    </div>
